...
["_main","_moduleUpdate","___original_main","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  66116: ($0) => { console.log(UTF8ToString($0)); }
};
...
/** @type {function(...*):?} */
var _moduleUpdate = Module["_moduleUpdate"] = createExportWrapper("moduleUpdate");
